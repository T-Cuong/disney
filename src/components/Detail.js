...
function Detail() {
  return (
    <Container>
      ...
      <Description>
        A Chinese mon who's sad when her grown son leaves home gets another chance at motherhood when one of her dumplings springs to life. But she find that nothing stays cute and small forever.
      </Description>
    </Container>
  )
}
